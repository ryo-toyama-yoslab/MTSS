...
public class ex_re_left_arm extends AppCompatActivity {
    private static int parts_obj;
    TestOpenHelperForTitle helper;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ex_re_left_arm);
    ...
    public void re_activity(View v){
        startActivity(new Intent(this,re_zintai.class));
    }
